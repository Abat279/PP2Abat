...
transport = [pygame.image.load(f'10/Racer/image/Topdown_vehicle_sprites_pack/{name}') for name in image_filenames]

vehicle_group = pygame.sprite.Group()
coin_group = pygame.sprite.Group()

crash_img = pygame.image.load('C:/Users/user/Downloads/crash.png')
bg_music = pygame.mixer.Sound('10/Racer/A_BOO_Senen_basqa_Yeski_Taspa (2).mp3')
crash_sound = pygame.mixer.Sound('10/Racer/craaash (1).mp3')
